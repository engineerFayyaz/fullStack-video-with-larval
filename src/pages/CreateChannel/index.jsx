  ...
  return (
    <>
      <div className="bg-gray-900 flex flex-col justify-start mx-auto p-2 w-full">
        ...
        <Text
          className="ml-3 md:ml-[0] mt-[37px] md:text-3xl sm:text-[28px] text-[32px] text-white-A700"
          size="txtCatamaranRomanBold32"
        >
          Create a new Channel
        </Text>
        <div className="flex flex-col font-nunitosans items-center justify-start mb-[257px] md:ml-[0] ml-[30px] mt-[41px] md:px-5 w-[87%] md:w-full">
          <div className="flex flex-col gap-8 items-end justify-start w-full">
            ...
            <div className="flex sm:flex-1 flex-col gap-1 items-start justify-start w-[40%] sm:w-full">
              ...
              <div className="flex sm:flex-1 flex-col gap-1 items-start justify-start w-[100%] sm:w-full">
                ...
                <Button
                  className="cursor-pointer font-bold font-catamaran rounded-br-[3px] rounded-tr-[3px] text-base text-center w-[271px]"
                  color="pink_500"
                  size="md"
                  variant="fill"
                >
